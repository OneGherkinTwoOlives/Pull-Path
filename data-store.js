const TSData = (() => {
  ...
  function normalizeProjectRow(row) {
    return {
      ...
      taskDurationUnit: row.task_duration_unit || null,
  ...
  function serializeProject(project) {
    return {
      ...
      task_duration_unit: project.taskDurationUnit || null,
      ...
      team_mode: project.teamMode || null,
